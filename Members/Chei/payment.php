  ...
  if (!$user_id) {
      ...
      if (empty($address)) {
        ...
        foreach ($phpCart as $index => $item) {
          ...
          error_log("Inserting order - OrderID: $order_id, UserID: $user_id, Address: $address, BookID: $book_id, Quantity: $qty, Total: $total_amount");
          ...
          error_log("Parameters - OrderID: $order_id (int), BookID: $book_id (string), Date: $order_date, Address: $address, Qty: $qty (int), User_ID: $user_id (string), Total: $total_amount (float)");
          
          $stmt->bind_param("isssisd", $order_id, $book_id, $order_date, $address, $qty, $user_id, $total_amount);
