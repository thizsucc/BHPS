                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="border rounded-lg overflow-hidden">
                                    <div class="flex flex-col md:flex-row items-start p-4">
                                        <?php if (!empty($order['ImagePath'])): ?>
                                            <div class="w-full md:w-1/4 mb-4 md:mb-0">
                                                <img src="<?php echo htmlspecialchars($order['ImagePath']); ?>"
                                                    alt="<?php echo htmlspecialchars($order['book_name']); ?>"
                                                    class="w-full h-48 object-contain rounded">
                                            </div>
                                        <?php endif; ?>
                                        <div class="w-full md:w-2/4 px-4">
                                            <h4 class="font-medium"><?php echo htmlspecialchars($order['book_name'] ?? 'Book #' . $order['BookID']); ?></h4>
                                            <?php if (!empty($order['Author'])): ?>
                                                <p class="text-gray-600 text-sm"><?php echo htmlspecialchars($order['Author']); ?></p>
                                            <?php endif; ?>
                                            <p class="text-gray-500 text-xs mt-1">Book ID: <?php echo $order['BookID']; ?></p>
                                        </div>
                                        <div class="w-full md:w-1/6 px-4">
                                            <p class="text-gray-600">Qty: <?php echo $order['Quantity']; ?></p>
                                        </div>
                                        <div class="w-full md:w-1/6 px-4 text-right">
                                            <p class="font-medium">RM<?php echo number_format($order['Total_Amount'] / $order['Quantity'], 2); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
