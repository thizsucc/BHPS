...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2025 at 06:57 PM
...
('B010', 'Ikigai', 'Héctor García', 'Academic', 'Physical', '48.5', 1, 'uploads/1759432714_ikigai.png', 'An insightful academic book that offers a comprehensive exploration of knowledge, fostering critical thinking and deeper understanding of its subject matter.', 1, 40.00),
...
('B025', ' Deep Work', 'Cal Newport', 'Business', 'Physical', '52.9', 20, 'uploads/1760024384_deepwork.jpg', 'An insightful business book that will take you on a transformative journey through strategy, innovation, and real-world success.', 1, 30.00),
...
('B029', 'Drunken Botanist', 'Amy Stewart', 'Food & Drink', 'Physical', '55.2', 20, 'uploads/1760027708_drunkenBotanist.jpg', 'A flavorful food and drink book that will take you on a delicious journey through recipes, culture, and culin', 0, NULL),
...
('B036', 'A History Ancient Rome In Twelve Coins', 'Gareth Harney', 'Academic', 'Physical', '47.9', 20, 'uploads/1760028847_rome.jpg', 'An insightful academic book that offers a comprehensive exploration of knowledge, fostering critical thinking and deeper understanding of its subject matter.', 0, NULL),
...
('E004', ' Illicit Obsession (E-book)', 'J.A Owenby', 'Romance', 'E-book', '20', 100, 'uploads/1760258773_illicit.jpg', 'A heartwarming romance book that will take you on an unforgettable journey of love, passion, and emotion.', 0, NULL),
...
INSERT INTO `order` (`OrderID`, `BookID`, `order_date`, `address`, `Quantity`, `User_ID`, `Status`, `Total_Amount`) VALUES
('1000000', 'B010', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 40.00),
('246342', 'B022', '2025-10-13', '415hgfaASDGH', 2, 'user001', 'Processing', 95.80),
('338801', 'B010', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 40.00),
('372379', 'E006', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 15.00),
('493843', 'B010', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 40.00),
('697289', 'E002', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 20.00),
('848819', 'B012', '2025-10-08', '1234dfghfb', 1, 'user001', 'Completed', 45.90),
('903868', 'B001', '2025-10-08', '415hgfaASDGH', 1, 'user002', 'Completed', 45.90),
('996140', 'B039', '2025-10-13', '415hgfaASDGH', 2, 'user001', 'Processing', 100.00),
('997075', 'B036', '2025-10-12', '415hgfaASDGH', 1, 'user003', 'Cancelled', 47.90),
('998627', 'B041', '2025-10-12', '415hgfaASDGH', 1, 'user003', 'Delivery', 55.20),
('999743', 'B015', '2025-10-12', '415hgfaASDGH', 1, 'user002', 'Processing', 49.90),
('999993', 'B039', '2025-10-12', '415hgfaASDGH', 1, 'user001', 'Processing', 50.00),
('999997', 'B015', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 49.90),
('999999', 'B015', '2025-10-13', '415hgfaASDGH', 1, 'user001', 'Processing', 49.90);
