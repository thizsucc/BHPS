...
<head>
    ...
    <title>Bestsellers - Book Heaven</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        .dropdown-menu { display: none; position: absolute; background-color: white; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); z-index: 1; }
        .dropdown-menu.show { display: block; }
        .dropdown-menu a { color: black; padding: 12px 16px; text-decoration: none; display: block; }
        .dropdown-menu a:hover { background-color: #f1f1f1; }
        .rotate-180 { transform: rotate(180deg); }
        .book-card { cursor: pointer; transition: all 0.3s ease; }
        ...
        .user-menu { display: none; position: absolute; right: 0; background-color: white; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); z-index: 1; min-width: 160px; border-radius: 4px; }
        .user-menu.show { display: block; }
        .action-panel { display: none; position: absolute; right: 0; background-color: white; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); z-index: 1; width: 320px; border-radius: 4px; max-height: 400px; overflow-y: auto; }
        .action-panel.show { display: block; }
        .cart-item { display: flex; align-items: center; padding: 10px; border-bottom: 1px solid #eee; }
        .cart-item img { width: 50px; height: 70px; object-fit: cover; margin-right: 10px; }
        .cart-item-details { flex-grow: 1; }
        .modal { display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center; }
        .modal-content { background: white; padding: 30px; border-radius: 10px; width: 90%; max-width: 800px; max-height: 80vh; overflow-y: auto; box-shadow: 0 5px 25px rgba(0, 0, 0, 0.2); }
    </style>
    <script>
...
<body class="bg-gray-50 font-sans">
                ...
                <div class="hidden md:flex flex-1 mx-8">
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" placeholder="Search bestsellers..." class="py-2 px-6 w-full focus:outline-none" style="min-width: 300px;">
                    ...
                    <?php if ($logged_in): ?>
                        <div class="relative">
                            ...
                            <div id="userDropdown" class="user-menu absolute mt-2 right-0">
                                <a href="OrderPage.php" class="block px-4 py-2 hover:bg-gray-100">Orders</a>
        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <span class="text-gray-500">Bestsellers</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            <aside class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4">About Bestsellers</h2>
                    <p class="text-gray-600">
                        Explore our top-selling books, handpicked by staff and loved by readers. Find your next favorite read!
                    </p>
                </div>
            </aside>
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        ...
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($bestseller_books); ?> results</span>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="book-card bg-white rounded-lg shadow-sm overflow-hidden" 
                            ...
                            <div class="relative">
                                <span class="absolute top-2 left-2 bg-yellow-600 text-white text-xs px-2 py-1 rounded">Bestseller</span>
                        ...
                        <?php if (empty($bestseller_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                ...
                                <p class="text-gray-500">No bestsellers found.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <form id="addToCartForm" method="POST">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <button type="button" onclick="document.getElementById('addToCartForm').submit()" class="border border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 flex-1">
                                    Buy Now
                                </button>
                            </div>
                        </form>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li class="flex items-center"><i class="fas fa-map-marker-alt mr-2"></i> 123 Book Street, Kuala Lumpur, Malaysia</li>
                        <li class="flex items-center"><i class="fas fa-phone-alt mr-2"></i> +603-1234 5678</li>
                        <li class="flex items-center"><i class="fas fa-envelope mr-2"></i> hello@bookheaven.com</li>
    ...
    <script>
        ...
        document.getElementById('addToCartForm').addEventListener('submit', function(e) {
            ...
            fetch('bestseller.php', { method: 'POST', body: formData })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
