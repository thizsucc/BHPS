        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <a href="children.php" class="text-blue-600 hover:text-blue-800">Categories</a>
                        <span class="mx-2">/</span>
                    </li>
                    <li class="flex items-center">
        ...
        <div class="container mx-auto px-4 mt-6">
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
                ...
                <span class="absolute top-0 bottom-0 right-0 px-4 py-3" onclick="this.parentElement.style.display='none';">
                    <svg class="fill-current h-6 w-6 text-green-500" role="button" xmlns="http://www.w3.org2000/svg" viewBox="0 0 20 20">
                        <title>Close</title>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div id="modalProductDescription" class="mb-6 text-gray-600">
                            A captivating children's book that will take young readers on an unforgettable journey through imagination and adventure.
                        </div>
            ...
            fetch(`get_book_details.php?book_id=${bookId}`)
                ...
                .then(book => {
                    ...
                    if (book.Description && book.Description.trim() !== '' && book.Description !== null) {
                        ...
                        descriptionElement.textContent = 'A captivating children\'s book that will take young readers on an unforgettable journey through imagination and adventure.';
                    }
