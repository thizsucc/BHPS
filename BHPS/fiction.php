...
$where = '';
if (!empty($search)) {
    $where = " WHERE (Name LIKE '%$search%' OR Author LIKE '%$search%' OR BookID LIKE '%$search%' OR Category LIKE '%$search%') AND Category = 'Fiction'";
} else {
    $where = " WHERE Category = 'Fiction'";
}

// Fetch books from Fiction category with search filter
$fiction_books = [];
...
<head>
    ...
    <title>Fiction Books - Book Heaven</title>
...
<body class="bg-gray-50 font-sans">
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                                   placeholder="Search fiction books, authors..." 
            ...
            <div class="md:hidden py-2">
                <div class="relative">
                    <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                               placeholder="Search fiction books..." 
        ...
        <div class="flex flex-col md:flex-row gap-8">
            <aside class="md:w-1/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        <li><a href="fiction.php" class="text-blue-600 hover:text-blue-800 font-medium">Fiction</a></li>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                      <h2 class="text-xl font-bold mb-4">About Fiction Books</h2>
                      <p class="text-gray-600 mb-4">
                          Explore our extensive collection of fiction books, ranging from bestselling novels to hidden gems.
                          Whether you're looking for thrilling mysteries, heartwarming romance, epic fantasy, or thought-provoking
                          literary fiction, we have something for every reader.
                      </p>
                      <p class="text-gray-600">
                          Our fiction category features works from acclaimed authors and emerging writers alike, with both
                          international bestsellers and local favorites. Discover new worlds, unforgettable characters, and
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold">Fiction Books</h1>
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($fiction_books); ?> results</span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($search)): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800">
                                ...
                                <a href="fiction.php" class="text-blue-600 hover:underline ml-4">Clear search</a>
                            </p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach ($fiction_books as $book): ?>
                        ...
                        <?php if (empty($fiction_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                ...
                                <p class="text-gray-500">No fiction books found<?php echo !empty($search) ? ' matching your search' : ''; ?>.</p>
                                <?php if (!empty($search)): ?>
                                    <a href="fiction.php" class="text-blue-600 hover:underline mt-2 inline-block">Browse all fiction books</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <script>
        ...
        function updateCartDisplay(cartData) {
            ...
            cartSubtotalNav.textContent = 'RM' + cartData.total.toFixed(2);
            cartShippingFee.textContent = 'RM' + (cartData.count > 0 ? '5.00' : '0.00');
            cartSubtotal.textContent = 'RM' + (cartData.total + (cartData.count > 0 ? 5 : 0)).toFixed(2);
        }
