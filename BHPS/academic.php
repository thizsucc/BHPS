...
$where = '';
if (!empty($search)) {
    $where = " WHERE (Name LIKE '%$search%' OR Author LIKE '%$search%' OR BookID LIKE '%$search%' OR Category LIKE '%$search%') AND Category = 'Academic'";
} else {
    $where = " WHERE Category = 'Academic'";
}

// Fetch books from Academic category with search filter
$academic_books = [];
...
<head>
    ...
    <title>Academic Books - Book Heaven</title>
...
<body class="bg-gray-50 font-sans">
                    ...
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                                placeholder="Search academic books, authors..."
        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <a href="academic.php" class="text-blue-600 hover:text-blue-800">Categories</a>
                        <span class="mx-2">/</span>
                    </li>
                    <li class="flex items-center">
            ...
            <aside class="md:w-1/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="academic.php" class="text-blue-600 hover:text-blue-800 font-medium">Academic</a></li>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4">About Academic Books</h2>
                    <p class="text-gray-600 mb-4">
                        Our academic category features works from distinguished scholars and emerging researchers alike,
                        spanning both internationally recognized publications and local contributions.
                        Explore groundbreaking studies, well-researched insights, and knowledge that will continue to inform and inspire long after the last page.
                    </p>
                </div>
            </aside>
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold">Academic Books</h1>
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($academic_books); ?> results</span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($search)): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800">
                                ...
                                <a href="academic.php" class="text-blue-600 hover:underline ml-4">Clear search</a>
                            </p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach ($academic_books as $book):
                            ...
                            <div class="book-card bg-white rounded-lg shadow-sm overflow-hidden"
                                ...
                                <div class="relative">
                                    ...
                                    <?php if (in_array($book['BookID'], $latest_book_ids)): ?>
                                        <span class="absolute top-2 <?php echo $is_promotion ? 'left-24' : 'left-2'; ?> bg-red-600 text-white text-xs px-2 py-1 rounded">NEW</span>
                                    <?php endif; ?>
                        ...
                        <?php if (empty($academic_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                <i class="fas fa-book-open text-4xl text-gray-400 mb-4"></i>
                                <p class="text-gray-500">No academic books found<?php echo !empty($search) ? ' matching your search' : ''; ?>.</p>
                                <?php if (!empty($search)): ?>
                                    <a href="academic.php" class="text-blue-600 hover:underline mt-2 inline-block">Browse all academic books</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div id="modalProductDescription" class="mb-6 text-gray-600">
                            A comprehensive academic resource that provides valuable insights and knowledge in its field.
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="academic.php" class="text-gray-400 hover:text-white">Academic</a></li>
                    </ul>
                </div>
    ...
    <script>
            ...
            fetch(`get_book_details.php?book_id=${bookId}`)
                ...
                .then(book => {
                    ...
                    if (book.Description && book.Description.trim() !== '' && book.Description !== null) {
                        ...
                        descriptionElement.textContent = 'A comprehensive academic resource that provides valuable insights and knowledge in its field.';
                    }
        ...
        `;
            ...
            // Apply free shipping if subtotal is more than 200
            if (subtotal <= 200) {
                shippingFee = 5.00;
            }
