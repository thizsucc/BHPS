...
// Fetch last 10 books (most recently added)
$new_release_books = [];
$result = $conn->query("SELECT * FROM book ORDER BY BookID DESC LIMIT 10");
if ($result) {
...
// Handle remove from cart via AJAX (if you add a cart panel later)
...
<body class="bg-gray-50 font-sans">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <?php if (empty($new_release_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                ...
                                <p class="text-gray-500">No new releases found.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <script>
        ...
        // Close the dropdown if clicked outside and modal outside click
