...
$where = '';
if (!empty($search)) {
    $where = " WHERE (Name LIKE '%$search%' OR Author LIKE '%$search%' OR BookID LIKE '%$search%' OR Category LIKE '%$search%') AND Category = 'Business'";
} else {
    $where = " WHERE Category = 'Business'";
}

// Fetch books from Business category with search filter
$business_books = [];
...
<head>
    ...
    <title>Business Books - Book Heaven</title>
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                                placeholder="Search business books, authors..."
            ...
            <div class="md:hidden py-2">
                <div class="relative">
                    <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                            placeholder="Search business books..."
            ...
            <aside class="md:w-1/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="business.php" class="text-blue-600 hover:text-blue-800 font-medium">Business</a></li>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4">About Business Books</h2>
                    <p class="text-gray-600 mb-4">
                        Our business category features works from renowned experts and emerging voices alike,
                        with both international bestsellers and practical guides. Discover strategies, case studies, and insights that will inspire growth, sharpen decision-making, and empower you to thrive in today's competitive world.
                    </p>
                </div>
            </aside>
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold">Business Books</h1>
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($business_books); ?> results</span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($search)): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800">
                                ...
                                <a href="business.php" class="text-blue-600 hover:underline ml-4">Clear search</a>
                            </p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach ($business_books as $book):
                        ...
                        <?php if (empty($business_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                <i class="fas fa-chart-line text-4xl text-gray-400 mb-4"></i>
                                <p class="text-gray-500">No business books found<?php echo !empty($search) ? ' matching your search' : ''; ?>.</p>
                                <?php if (!empty($search)): ?>
                                    <a href="business.php" class="text-blue-600 hover:underline mt-2 inline-block">Browse all business books</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div id="modalProductDescription" class="mb-6 text-gray-600">
                            A comprehensive business book that provides valuable insights and strategies for success in today's competitive market.
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="business.php" class="text-gray-400 hover:text-white">Business</a></li>
            ...
            fetch(`get_book_details.php?book_id=${bookId}`)
                ...
                .then(book => {
                    ...
                    if (book.Description && book.Description.trim() !== '' && book.Description !== null) {
                        ...
                        descriptionElement.textContent = 'A comprehensive business book that provides valuable insights and strategies for success in today\'s competitive market.';
                    }
