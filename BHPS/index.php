    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                <a href="about.php" class="bg-white text-blue-800 px-6 py-3 rounded-full font-medium hover:bg-gray-100 inline-block transition duration-300">Learn More About Us</a>
            </div>
