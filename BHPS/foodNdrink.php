...
$where = '';
if (!empty($search)) {
    $where = " WHERE (Name LIKE '%$search%' OR Author LIKE '%$search%' OR BookID LIKE '%$search%' OR Category LIKE '%$search%') AND Category = 'Food & Drink'";
} else {
    $where = " WHERE Category = 'Food & Drink'";
}

// Fetch books from Food & Drink category with search filter
$food_books = [];
...
<head>
    ...
    <title>Food & Drink Books - Book Heaven</title>
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                                placeholder="Search food & drink books, authors..."
            ...
            <div class="md:hidden py-2">
                <div class="relative">
                    <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                            placeholder="Search food & drink books..."
        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <span class="text-gray-500">Food & Drink</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <aside class="md:w-1/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="foodNdrink.php" class="text-blue-600 hover:text-blue-800 font-medium">Food & Drink</a></li>
                        <li><a href="romance.php" class="text-gray-700 hover:text-blue-600">Romance</a></li>
                    </ul>
                </div>

                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4">About Food & Drink Books</h2>
                    <p class="text-gray-600 mb-4">
                        Our food and drink category features works from celebrated chefs and passionate food writers,
                        with both international favorites and local specialties. Discover delicious recipes, cooking techniques,
                        and culinary stories that will inspire your kitchen adventures and bring flavor to every occasion.
                    </p>
                </div>
            </aside>
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold">Food & Drink Books</h1>
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($food_books); ?> results</span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($search)): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800">
                                ...
                                <a href="foodNdrink.php" class="text-blue-600 hover:underline ml-4">Clear search</a>
                            </p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach ($food_books as $book):
                        ...
                        <?php if (empty($food_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                <i class="fas fa-utensils text-4xl text-gray-400 mb-4"></i>
                                <p class="text-gray-500">No food & drink books found<?php echo !empty($search) ? ' matching your search' : ''; ?>.</p>
                                <?php if (!empty($search)): ?>
                                    <a href="foodNdrink.php" class="text-blue-600 hover:underline mt-2 inline-block">Browse all food & drink books</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div id="modalProductDescription" class="mb-6 text-gray-600">
                            A captivating book that will take you on an unforgettable journey through culinary delights and cooking adventures.
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="foodNdrink.php" class="text-gray-400 hover:text-white">Food & Drink</a></li>
            ...
            fetch(`get_book_details.php?book_id=${bookId}`)
                ...
                .then(book => {
                    ...
                    if (book.Description && book.Description.trim() !== '' && book.Description !== null) {
                        ...
                        descriptionElement.textContent = 'A captivating book that will take you on an unforgettable journey through culinary delights and cooking adventures.';
                    }
