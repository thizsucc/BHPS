...
$where = '';
if (!empty($search)) {
    $where = " WHERE (Name LIKE '%$search%' OR Author LIKE '%$search%' OR BookID LIKE '%$search%' OR Category LIKE '%$search%') AND Category = 'Romance'";
} else {
    $where = " WHERE Category = 'Romance'";
}

// Fetch books from Romance category with search filter
$romance_books = [];
...
<head>
    ...
    <title>Romance Books - Book Heaven</title>
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="relative w-full max-w-xl">
                        <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                                placeholder="Search romance books, authors..."
            ...
            <div class="md:hidden py-2">
                <div class="relative">
                    <form method="GET" class="search-box flex items-center border rounded-full overflow-hidden">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                            placeholder="Search romance books..."
        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <span class="text-gray-500">Romance</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <aside class="md:w-1/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="romance.php" class="text-blue-600 hover:text-blue-800 font-medium">Romance</a></li>
                    </ul>
                </div>

                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4">About Romance Books</h2>
                    <p class="text-gray-600 mb-4">
                        Our romance category features works from beloved authors and rising storytellers,
                        with both timeless classics and modern favorites. Discover heartfelt tales,
                        unforgettable characters, and emotional journeys that will sweep you away into worlds of passion,
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold">Romance Books</h1>
                        <div class="flex items-center mt-4 md:mt-0">
                            <span class="text-gray-600">Showing <?php echo count($romance_books); ?> results</span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($search)): ?>
                        <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800">
                                ...
                                <a href="romance.php" class="text-blue-600 hover:underline ml-4">Clear search</a>
                            </p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <?php if (empty($romance_books)): ?>
                            <div class="col-span-3 text-center py-8">
                                ...
                                <p class="text-gray-500">No romance books found<?php echo !empty($search) ? ' matching your search' : ''; ?>.</p>
                                <?php if (!empty($search)): ?>
                                    <a href="romance.php" class="text-blue-600 hover:underline mt-2 inline-block">Browse all romance books</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="romance.php" class="text-gray-400 hover:text-white">Romance</a></li>
