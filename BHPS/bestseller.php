                        ...
                        ?>
                            <div class="book-card bg-white rounded-lg shadow-sm overflow-hidden"
                                ...
                                <div class="relative">
                                    ...
                                    <?php if ($is_promotion): ?>
                                        <span class="absolute top-2 left-20 bg-red-600 text-white text-xs px-2 py-1 rounded">PROMOTION</span>
                                    <?php endif; ?>
                                    <?php if (in_array($book['BookID'], $latest_book_ids)): ?>
                                        <span class="absolute top-9 <?php echo $is_promotion ? 'left-2' : 'left-2'; ?> bg-red-600 text-white text-xs px-2 py-1 rounded">NEW</span>
                                    <?php endif; ?>
